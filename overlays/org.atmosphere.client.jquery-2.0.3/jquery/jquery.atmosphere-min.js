...
}}else{if(ax.enableProtocol&&ax.firstMessage){au=false
}else{aj(ax)
}}return au
...
if(av.readyState>1){ay=av.status>1000?0:av.status
...
jQuery.each(I.headers,function(aw,ay){var ax=jQuery.isFunction(ay)?ay.call(this,I,I,Q):ay;
if(ax!=null){av+="&"+encodeURIComponent(aw)+"="+encodeURIComponent(ax)
}});
